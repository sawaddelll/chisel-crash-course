...
VL_MODULE(VTest) {
  public:
    ...
    // Begin mtask footprint  all: 
    VL_SIG8(Test__DOT__value,7,0);
    VL_SIG8(Test__DOT___T_24,7,0);
    VL_SIG8(Test__DOT__decodeTestC__DOT__countingLeadingZeros__DOT__tree__DOT__CountLeadingZerosTree_io_out,2,0);
    VL_SIG8(Test__DOT__decodeTestC__DOT__countingLeadingZeros__DOT__tree__DOT__rCountExtend,2,0);
    VL_SIG8(Test__DOT__endToEndTest__DOT__encode_io_out_bits,7,0);
  ...
  public:
    ...
    static void _initial__TOP__3(VTest__Syms* __restrict vlSymsp);
    static void _sequent__TOP__2(VTest__Syms* __restrict vlSymsp);
    static void _settle__TOP__1(VTest__Syms* __restrict vlSymsp);
